...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function(){
        cy.get('#firstName').type('Raliane').should('have.value', 'Raliane').clear().should('have.value', '')
        cy.get('#lastName').type('Mendes').should('have.value', 'Mendes').clear().should('have.value', '')
        cy.get('#email').type('ralianemc@gmail.com').should('have.value', 'ralianemc@gmail.com').clear().should('have.value', '')
